...
<!DOCTYPE PLT>
<PLT DOC_VERSION="23.4.0">
    <PLOT_CFG>
        <WINDOW_GEOMETRY>591 223 733 784</WINDOW_GEOMETRY>
        <ITEMS_LIST>
            <ITEM type="dpv">
                <UNIT>s</UNIT>
                <NAME>A0</NAME>
            ...
            <ITEM type="dpv">
                <UNIT>g</UNIT>
                <NAME>A1</NAME>
                <REF_TITLE>fcons@engine</REF_TITLE>
            </ITEM>
            <ITEM type="dpv">
                <UNIT>mg/s</UNIT>
                <NAME>A2</NAME>
                <REF_TITLE>emiCO2@engine</REF_TITLE>
            </ITEM>
            <ITEM type="dpv">
                <UNIT>m/s</UNIT>
                <NAME>A3</NAME>
                <REF_TITLE>v5@vehicle</REF_TITLE>
            </ITEM>
        </ITEMS_LIST>
        <INPUT_ITEMS_LIST/>
        <COMPUTATION_LIST/>
        <PAGE_CFG>
            ...
            <AREAS_LIST>
                ...
                <AREA>
                    <GEOMETRY>0 238 731 238</GEOMETRY>
                    <GRAPH_RENDERER type="2D Graph">
                        <MARGIN_COLOR>255 255 255</MARGIN_COLOR>
                        <MARGIN_SIZE>46 43 3 3 56 0 56 56</MARGIN_SIZE>
                        <AREA_COLOR>255 255 255</AREA_COLOR>
                ...
                <AREA>
                    <GEOMETRY>0 476 731 238</GEOMETRY>
                    <GRAPH_RENDERER type="2D Graph">
                        <MARGIN_COLOR>255 255 255</MARGIN_COLOR>
                        <MARGIN_SIZE>46 43 3 3 56 0 56 56</MARGIN_SIZE>
                        <AREA_COLOR>255 255 255</AREA_COLOR>
