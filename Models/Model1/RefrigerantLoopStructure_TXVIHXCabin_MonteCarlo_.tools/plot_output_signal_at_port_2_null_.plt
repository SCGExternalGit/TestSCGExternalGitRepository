...
<PLT DOC_VERSION="16.0.0">
    <PLOT_CFG>
        <WINDOW_GEOMETRY>402 209 957 516</WINDOW_GEOMETRY>
        <ITEMS_LIST>
            <ITEM type="dpv">
                <UNIT>s</UNIT>
                <NAME>A0</NAME>
            ...
            <ITEM type="dpv">
                <UNIT>degC</UNIT>
                <NAME>A1</NAME>
                <REF_TITLE>t3@tpf_ma_sensor_4</REF_TITLE>
            </ITEM>
            <ITEM type="dpv">
                <UNIT>barA</UNIT>
                <NAME>A2</NAME>
                <REF_TITLE>p3@tpf_ma_sensor_3</REF_TITLE>
            </ITEM>
            <ITEM type="dpv">
                <UNIT>%</UNIT>
                <NAME>A3</NAME>
                <REF_TITLE>rh3@tpf_ma_sensor_2</REF_TITLE>
            </ITEM>
            <ITEM type="dpv">
                <UNIT>kg/s</UNIT>
                <NAME>A4</NAME>
                <REF_TITLE>dm3@th_ma_flow_sensor</REF_TITLE>
            </ITEM>
        </ITEMS_LIST>
        <INPUT_ITEMS_LIST/>
        <COMPUTATION_LIST/>
        <PAGE_CFG>
            ...
            <AREAS_LIST>
                <AREA>
                    <GEOMETRY>0 0 955 446</GEOMETRY>
                    <GRAPH_RENDERER type="2D Graph">
                        <MARGIN_COLOR>255 255 255</MARGIN_COLOR>
                        <MARGIN_SIZE>46 43 3 3 224 0 56 56</MARGIN_SIZE>
                    ...
                    <CURVE type="2D curve">
                        <TITLE>
                            <TEXT>temperature &lt;ITEM_UNIT></TEXT>
                            <RGB_FG_COLOR>0 0 0</RGB_FG_COLOR>
                            <FONT_FAMILY>MS Shell Dlg 2</FONT_FAMILY>
                            <FONT_SIZE>8</FONT_SIZE>
                            <FONT_STYLE>50 0</FONT_STYLE>
                    ...
                    <CURVE type="2D curve">
                        ...
                        <YAXIS_RANK>0 1</YAXIS_RANK>
                    </CURVE>
                    <CURVE type="2D curve">
                        <TITLE>
                            <TEXT>relative humidity &lt;ITEM_UNIT></TEXT>
                            <RGB_FG_COLOR>0 0 0</RGB_FG_COLOR>
                            <FONT_FAMILY>MS Shell Dlg 2</FONT_FAMILY>
                            <FONT_SIZE>8</FONT_SIZE>
                            <FONT_STYLE>50 0</FONT_STYLE>
                        ...
                        <YAXIS_RANK>0 2</YAXIS_RANK>
                    </CURVE>
                    <CURVE type="2D curve">
                        <TITLE>
                            <TEXT>mass flow rate &lt;ITEM_UNIT></TEXT>
                            <RGB_FG_COLOR>0 0 0</RGB_FG_COLOR>
                            <FONT_FAMILY>MS Shell Dlg 2</FONT_FAMILY>
                            <FONT_SIZE>8</FONT_SIZE>
                            <FONT_STYLE>50 0</FONT_STYLE>
